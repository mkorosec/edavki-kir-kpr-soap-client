...
public class ISoapServiceGetPermissionsBadRequestFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public ISoapServiceGetPermissionsBadRequestFaultFaultFaultMessage(String message, BadRequestFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public ISoapServiceGetPermissionsBadRequestFaultFaultFaultMessage(String message, BadRequestFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
