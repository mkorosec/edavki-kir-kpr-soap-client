...
public class ISoapServiceUploadInvoiceBookBadRequestFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public ISoapServiceUploadInvoiceBookBadRequestFaultFaultFaultMessage(String message, BadRequestFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public ISoapServiceUploadInvoiceBookBadRequestFaultFaultFaultMessage(String message, BadRequestFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
