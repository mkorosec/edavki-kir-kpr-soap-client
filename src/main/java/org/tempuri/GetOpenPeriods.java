...
@XmlRootElement(name = "GetOpenPeriods")
public class GetOpenPeriods {

    @XmlElementRef(name = "formCode", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
