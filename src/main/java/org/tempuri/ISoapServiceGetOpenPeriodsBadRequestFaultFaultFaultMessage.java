...
public class ISoapServiceGetOpenPeriodsBadRequestFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public ISoapServiceGetOpenPeriodsBadRequestFaultFaultFaultMessage(String message, BadRequestFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public ISoapServiceGetOpenPeriodsBadRequestFaultFaultFaultMessage(String message, BadRequestFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
